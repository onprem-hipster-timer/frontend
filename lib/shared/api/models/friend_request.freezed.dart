...
mixin _$FriendRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, addresseeId);

  @override
  String toString() {
    return 'FriendRequest(addresseeId: $addresseeId)';
  }
}
...
abstract mixin class $FriendRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'addressee_id') String addresseeId});
}
...
extension FriendRequestPatterns on FriendRequest {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FriendRequest value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'addressee_id') String addresseeId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FriendRequest() when $default != null:
        return $default(_that.addresseeId);
      case _:
        return orElse();
    }
  }
