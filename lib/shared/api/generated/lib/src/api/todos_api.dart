...
import 'package:momeet_api/src/model/todo_create.dart';
import 'package:momeet_api/src/model/todo_read.dart';
import 'package:momeet_api/src/model/todo_stats.dart';
import 'package:momeet_api/src/model/todo_update.dart';
...
class TodosApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TodoRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodoRead>> createTodoV1TodosPost({ 
    required TodoCreate todoCreate,
    ...
    try {
      const _type = FullType(TodoCreate);
      _bodyData = _serializers.serialize(todoCreate, specifiedType: _type);
    ...
    TodoRead? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TodoRead),
      ) as TodoRead;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> deleteTodoV1TodosTodoIdDelete({ 
    ...
    final _path = r'/v1/todos/{todo_id}'.replaceAll('{' r'todo_id' '}', encodeQueryParameter(_serializers, todoId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TimerRead>> getTodoActiveTimerV1TodosTodoIdTimersActiveGet({ 
    required String todoId,
    ...
    final _path = r'/v1/todos/{todo_id}/timers/active'.replaceAll('{' r'todo_id' '}', encodeQueryParameter(_serializers, todoId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TodoStats] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodoStats>> getTodoStatsV1TodosStatsGet({ 
    String? groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _queryParameters = <String, dynamic>{
      r'group_id': encodeQueryParameter(_serializers, groupId, const FullType(String)),
    };
    ...
    TodoStats? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TodoStats),
      ) as TodoStats;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TimerRead>>> getTodoTimersV1TodosTodoIdTimersGet({ 
    required String todoId,
    bool? includeTodo = false,
    String? timezone,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/todos/{todo_id}/timers'.replaceAll('{' r'todo_id' '}', encodeQueryParameter(_serializers, todoId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [TodoRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodoRead>> readTodoV1TodosTodoIdGet({ 
    required String todoId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<BuiltList<TodoRead>>> readTodosV1TodosGet({ 
    ...
    BuiltList<TodoRead>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(TodoRead)]),
      ) as BuiltList<TodoRead>;
    ...
    return Response<BuiltList<TodoRead>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [TodoRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodoRead>> updateTodoV1TodosTodoIdPatch({ 
    required String todoId,
    ...
    try {
      const _type = FullType(TodoUpdate);
      _bodyData = _serializers.serialize(todoUpdate, specifiedType: _type);
