...
class _FriendsClient implements FriendsClient {
  _FriendsClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<FriendRead>> listFriendsV1FriendsGet({
    ...
    late List<FriendRead> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => FriendRead.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<PendingRequestRead>>
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/v1/friends/requests/received',
    )..data = _data;
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<PendingRequestRead> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                PendingRequestRead.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<FriendshipRead> sendFriendRequestV1FriendsRequestsPost({
    ...
    late FriendshipRead _value;
    try {
      _value = FriendshipRead.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<FriendshipRead>
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/v1/friends/requests/${friendshipId}/accept',
    )..data = _data;
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late FriendshipRead _value;
    try {
  ...
  Future<void> rejectFriendRequestV1FriendsRequestsFriendshipIdRejectPost({
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/v1/friends/requests/${friendshipId}/reject',
    )..data = _data;
  ...
  Future<void> cancelFriendRequestV1FriendsRequestsFriendshipIdDelete({
    ...
    final _options = newOptions.copyWith(
      ...
      baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl),
      queryParameters: queryParameters,
      path: '/v1/friends/requests/${friendshipId}',
    )..data = _data;
    await _dio.fetch<void>(_options);
  }
