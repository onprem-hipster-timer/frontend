...
class TokenExpiredException extends AuthException {
  TokenExpiredException({String? message, super.originalError})
    : super(
        message: message ?? _l('인증이 만료되었습니다. 다시 로그인해주세요', 'Session expired'),
      );
}
...
class ServerException extends AppException {
  ...
  ServerException({String? message, this.statusCode, super.originalError})
    : super(message: message ?? _l('서버 오류가 발생했습니다', 'Server error'));
}

/// 유효성 검증 오류
class ValidationException extends AppException {
  ValidationException({String? message, super.originalError})
...
class PermissionException extends AppException {
  PermissionException({String? message, super.originalError})
...
class UnknownException extends AppException {
  UnknownException({String? message, super.originalError})
    : super(
        message:
            message ?? _l('알 수 없는 오류가 발생했습니다', 'An unknown error occurred'),
      );
}
